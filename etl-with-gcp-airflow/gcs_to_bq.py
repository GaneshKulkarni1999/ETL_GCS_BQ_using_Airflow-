...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bkt-src-global-data-01',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='restapitable.staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV',
